...
def welcome(m):
    ...
    a = types.InlineKeyboardButton("TeaMToP \xE2\x9C\x8C", url="https://telegram.me/Teamtop")
    c = types.InlineKeyboardButton("Add group \xE2\x9C\x8C", url="https://telegram.me/phythone_info_bot?startgroup=test")
    markup.add(a, c)
    b = types.InlineKeyboardButton("Developer ID bot \xE2\x9C\x8C", url="https://telegram.me/ahmedjabbar1")
    markup.add(b)
...
def p(m):
    ...
    a = types.InlineKeyboardButton('Facebook', url='www.facebook.com/ahmedjabbarkasad')
    b = types.InlineKeyboardButton('Huawie', url='https://telegram.me/Huawei_onlin_bot')
   k = types.InlineKeyboardButton('DevTop', url='https://telegram.me/DevTop')
    j = types.InlineKeyboardButton('Bot', url='https://telegram.me/aHmedjabbar_bot')
    o = types.InlineKeyboardButton('TeaMToP', url='https://telegram.me/TeamTop')
    markup.add(v)
    markup.add(a, j)
    markup.add(b, c)
    markup.add(n, m)
    ...
    markup.add(ch, git)
    bot.send_chat_action(uid, 'typing')
    bot.send_message(uid, "TeaMToP development Telegram bot and web mastering \n\n developers : \n [negative](https://telegram.me/ahmedjabbar1) \n [Parham](https://telegram.me/Teamtop)", parse_mode="Markdown")
    bot.send_photo(uid, open('taylor.jpg'), caption="@TeamToP", reply_markup=markup)

@bot.message_handler(commands=['idbot'])
def handler(m):
    cid = m.chat.id
    bot.send_message(cid, "My Name is ID bot \n creator and developer : [negative](https://telegram.me/ahmedjabbar1) \n development channel : [TeaMToP](https://telegram.me/@TeamTop)\n\n [github](https://github.com/ahmedjabbar1/phython_info)", parse_mode="Markdown")
